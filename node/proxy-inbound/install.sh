...
mkdir -p /mnt/streaming/rec
mkdir -p /var/www/html

## set ownership
chown -R www-data:www-data /mnt/streaming /var/www/html

## enter nginx folder
cd /etc/nginx

## replace nginx.conf
wget --no-check-certificate -O /etc/nginx/nginx.conf http://git.genexnetworks.net/whittinghamj/pdx-project-zeus-v2/-/raw/main/node/proxy-inbound/nginx.conf
...
## download php files
wget --no-check-certificate -O /var/www/html/rtmp_done.php http://git.genexnetworks.net/whittinghamj/pdx-project-zeus-v2/-/raw/main/node/proxy-inbound/rtmp_done.php

## install zeus
mkdir -p /opt/zeus/console
mkdir -p /opt/zeus/inc
mkdir -p /opt/zeus/logs
...
## install crontab
wget --no-check-certificate -O /opt/zeus/crontab.txt http://git.genexnetworks.net/whittinghamj/pdx-project-zeus-v2/-/raw/main/node/proxy-inbound/crontab.txt
crontab /opt/zeus/crontab.txt

## get release_version.txt
wget --no-check-certificate -O /opt/zeus/release_version.txt http://git.genexnetworks.net/whittinghamj/pdx-project-zeus-v2/-/raw/main/node/proxy-inbound/release_version.txt

## get console deamon app
wget --no-check-certificate -O /opt/zeus/console/console.php http://git.genexnetworks.net/whittinghamj/pdx-project-zeus-v2/-/raw/main/node/proxy-inbound/console/console.php
wget --no-check-certificate -O /opt/zeus/inc/functions.php http://git.genexnetworks.net/whittinghamj/pdx-project-zeus-v2/-/raw/main/node/proxy-inbound/inc/functions.php
wget --no-check-certificate -O /opt/zeus/inc/php_colors.php http://git.genexnetworks.net/whittinghamj/pdx-project-zeus-v2/-/raw/main/node/proxy-inbound/inc/php_colors.php
